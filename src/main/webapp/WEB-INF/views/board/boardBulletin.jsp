...
<div class="col-lg-9">
    ...
    <div class="d-flex flex-row-reverse">
        <a href="board/saveForm" class="btn btn-sm btn-outline-success" style="margin-right: 10px;">
            글쓰기</a>
    </div>
    <br>
        ...
        <c:choose>
            <c:when test="${boards.first}">
                <li class="page-item disabled"><a class="page-link"
                                                  href="?page=${boards.number -1 }">Previous</a>
                </li>
            </c:when>
            <c:otherwise>
...
<p> &ensp;</p> <p> &ensp;</p> <p> &ensp;</p> <p> &ensp;</p> <p> &ensp;</p> <p> &ensp;</p>
        <c:choose>
